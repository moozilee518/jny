...
log4js.configure({
    appenders: [{
        ...
        {
            type: 'dateFile',
            filename: '/mnt/logs/nodejs/channel_test/stdout/stdout.log',
            pattern: '_yyyy-MM-dd',
        ...
        {
            type: 'dateFile',
            filename: '/mnt/logs/nodejs/channel_test/connect/connect.log',
            pattern: '_yyyy-MM-dd',
            alwaysIncludePattern: true,
            layout: {
                type: 'basic'
        ...
        {
            type: 'dateFile',
            filename: '/mnt/logs/nodejs/channel_test/subscribe_order/subscribe_order.log',
            pattern: '_yyyy-MM-dd',
            alwaysIncludePattern: true,
            layout: {
                type: 'pattern',
        ...
        {
            type: 'dateFile',
            filename: '/mnt/logs/nodejs/channel_test/subscribe_accepted/subscribe_accepted.log',
            pattern: '_yyyy-MM-dd',
            alwaysIncludePattern: true,
            layout: {
                type: 'pattern',
